fun main() {
    ...
    fun getAntinodePositions(antenna1: Pair<Int,Int>, antenna2: Pair<Int,Int>): List<Pair<Int,Int>> {
        val antionePositions: MutableList<Pair<Int,Int>> = mutableListOf()

        val deltaRow = antenna2.first - antenna1.first
        val deltaColumn = antenna2.second - antenna1.second

        antionePositions.add(Pair(antenna1.first - deltaRow,antenna1.second - deltaColumn))
        antionePositions.add(Pair(antenna2.first + deltaRow,antenna2.second + deltaColumn))

        return antionePositions
